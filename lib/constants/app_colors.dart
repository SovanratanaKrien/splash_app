...
class AppColors {
  ...
  static const Color secondaryDark = Color(0xFFE04F6D);

  // Neutrals
  static const Color background = Color(0xFFF8F9FB);
  static const Color surface = Color(0xFFFFFFFF);
  static const Color error = Color(0xFFC51E10);
  ...
  static const Color redPink = Color(0xFFF83758);
  ...
  static const Color redAccent = Color(0xFFE60026);
